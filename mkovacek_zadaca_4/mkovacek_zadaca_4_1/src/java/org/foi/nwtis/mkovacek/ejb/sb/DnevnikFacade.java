...
/**
 * Facade klasa za entity klasu Dnevnik
 *
 * @author mkovacek
 */
@Stateless
public class DnevnikFacade extends AbstractFacade<Dnevnik> {
     ...
     */
    public List<Dnevnik> filter(String korisnik, String ipAdresa, String trajanje, String status, String odDatum, String doDatum) {
