 ...
 * @author Matija
 */
@WebFilter(filterName = "KontrolaPristupa", urlPatterns = {"/privatno/*"}, dispatcherTypes = {DispatcherType.REQUEST, DispatcherType.FORWARD, DispatcherType.ERROR, DispatcherType.INCLUDE})
public class KontrolaPristupa implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if(hs == null || hs.getAttribute("user") == null){
            String odrediste = "/PrijavaKorisnika";
