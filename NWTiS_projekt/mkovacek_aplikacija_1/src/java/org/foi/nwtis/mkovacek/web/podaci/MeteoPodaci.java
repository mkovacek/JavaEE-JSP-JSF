...
public class MeteoPodaci {
    ...
    public MeteoPodaci(Date sunRise, Date sunSet, Float humidityValue, Float pressureValue, String weatherValue, Date lastUpdate) {
        this.sunRise = sunRise;
        this.sunSet = sunSet;
        this.humidityValue = humidityValue;
        this.pressureValue = pressureValue;
    ...
    public MeteoPodaci(Date sunRise, Date sunSet, Float temperatureValue, Float pressureValue, String weatherValue, Date lastUpdate, String adresa) {
        this.sunRise = sunRise;
        this.sunSet = sunSet;
        this.temperatureValue = temperatureValue;
        this.pressureValue = pressureValue;
    ...
    public MeteoPodaci(Float temperatureValue,  Float pressureValue, String weatherValue, Date lastUpdate) {
        this.temperatureValue = temperatureValue;
        this.pressureValue = pressureValue;
        this.weatherValue = weatherValue;
        this.lastUpdate = lastUpdate;
