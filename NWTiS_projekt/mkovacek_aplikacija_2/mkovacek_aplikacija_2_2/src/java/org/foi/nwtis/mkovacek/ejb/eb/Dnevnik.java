...
public class Dnevnik implements Serializable {
    ...
    public Dnevnik(Integer id, String korisnik, String zahtjev, String url, String ipadresa, Date vrijeme, int trajanje, int status) {
        this.id = id;
    ...
    public String toString() {
        return "org.foi.nwtis.mkovacek.ejb.eb.Dnevnik[ id=" + id + " ]";
    }
